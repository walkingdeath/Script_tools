...
class RunTests(object):
    ...
    def LoadAndRunTestCases(self):
        try:
            ...
            LogUtility.logger.log("Failed running test cases, error message: {}".format(str(err)))
        finally:
    ...
    def CreateRunFolder(self):
        try:
            ...
            LogUtility.logger.log("Failed creating run folder, error message: {}".format(str(err)))
