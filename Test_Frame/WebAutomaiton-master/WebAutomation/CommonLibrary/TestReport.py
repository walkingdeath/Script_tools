...
class TestReport(object):
    ...
    def __init__(self):
        ...
        # self.reportfile = r'F:\qgk\python\WebAutomaiton-master\WebAutomation\TestRun\TestResult{0}.html'.format(datetime.datetime.now())
        self.reportfile = 'F:\qgk\python\WebAutomaiton-master\WebAutomation\TestRun\TestResult{0}.html'.format(datetime.datetime.now().strftime('%Y-%m-%d %H-%M-%S'))
